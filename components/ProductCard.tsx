...
const ProductCard = ({ product }: { product: Product }) => {
  return (
    <div className="text-sm border-[1px] border-dark_blue_/20 rounded-md bg-white group">
        ...
        {product?.status === "hot" && (
          ...
          >
            <Flame
              size={18}
              fill="#fb6c08"
              className="text-shop_orange/50 group-hover:text-shop_orange hooverEffect"
            />
          </Link>
        )}
      </div>
